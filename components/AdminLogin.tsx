// DEPRECATED: This component is unused and uses an insecure, hardcoded password.
// The active and correct version using Firebase Authentication is located at /components/admin/AdminLogin.tsx
